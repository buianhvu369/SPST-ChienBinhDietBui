...
public class FactoryCenter extends MyActor {
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        batch.draw(ongkhoi,x+64,y+32*5,getOriginX(), getOriginY(),32,64,getScaleX(), getScaleY(), getRotation());
        batch.draw(miengongkhoi,x+64,y+32*6,getOriginX(), getOriginY(),32,32,getScaleX(), getScaleY(), getRotation());
    }
}

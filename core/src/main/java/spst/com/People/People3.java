...
public class People3 extends MyActor {
    ...
    public People3(float x, float y, Stage s, boolean rightside) {
        ...
        TextureRegion[] textureRegionRight = {Utils.getRegion(16 * 26, 16 * 9, 16, 16), Utils.getRegion(16 * 26, 16 * 10, 16, 16), Utils.getRegion(16 * 26, 16 * 11, 16, 16)};

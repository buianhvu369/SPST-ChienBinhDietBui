...
public class Master implements Screen {
    ...
    public static int sotiencangiam ;
    public static boolean isNgayTrongCay = false;
    public static boolean isNgayGiamGia = false;
    public static boolean isNgayQuyenGop = false;
    ...
    public static boolean thongTinNutRiu = false;
    ...
    public static boolean thongTinRiu = false;
    ...
    public Master(StartGame game) {
        ...
        soluongNangLuongBan = MathUtils.random(300, 500 );
        ...
        button1C.addListener(new ClickListener() {
            public void clicked(InputEvent event, float x, float y) {
                if(GameState.money>= 2000*sotiencangiam/100&&GameState.ernegy>=20&& GameState.soMayLocBought <= (GameState.soMLtoidacothemua-1)) {
                    Master.soMayLoc++;
                    GameState.money-=500*sotiencangiam/100;
                    GameState.ernegy-=20;
        ...
        button6C.addListener(new ClickListener() {
            public void clicked(InputEvent event, float x, float y) {
                if(GameState.money >= 1500*sotiencangiam/100 && GameState.ernegy >= 30 && GameState.greenscore >= 30){
                    isCNX = true;
                    button6C.setColor(Color.GRAY);
                    GameState.money -=1500*sotiencangiam/100;
                    GameState.ernegy -=30;
        ...
        button4C.addListener(new ClickListener() {
            public void clicked(InputEvent event, float x, float y) {
                if(GameState.money>=100*sotiencangiam/100&&GameState.greenscore  >=5&& soluongBienCamBan>=0) {
                    Master.amountSeed++;
                    GameState.greenscore -= 5;
        ...
        spend100$ = new WhiteButton(100000, 1000, noMoveStage);
        spend100$.setSize(32*7, 60);
        spend200$ = new WhiteButton(100000, 1000, noMoveStage);
        spend200$.setSize(32*7, 60);
        spend500$ = new WhiteButton(100000, 1000, noMoveStage);
        spend500$.setSize(32*7, 60);
        spend1Day = new WhiteButton(100000, 1000, noMoveStage);
        spend1Day.setSize(32*7, 60);
        spend2Day = new WhiteButton(100000, 1000, noMoveStage);
       ...
       // nutMayLoc = new creatMayLoc(-1000,-1000,noMoveStage);
        ...
        riuButton = new CamRiu(Gdx.graphics.getWidth()-300,Gdx.graphics.getHeight()-70-45*3,noMoveStage);
        xengButton.remove();
        choiButton.remove();
        riuButton.remove();
        {// TỪ DẤU MỞ NGOẶC NHỌN ĐẾN HẾT CHỈ XỬ LÝ ẤN VÀO NÚT ITEM VÀ CÁC NÚT BÊN TRONG ITEM
            ...
            riuButton.addListener(new ClickListener() {
                @Override
                public void clicked(InputEvent event, float x, float y) {
                    if(GameState.isCoRiu){
                        if(!Master.whatActionIfClickMouse.equals("CamRiu")) {
                            Master.whatActionIfClickMouse = "CamRiu";
                            riuButton.textureRegion = new TextureRegion(riuButton.texture1);
                        }else{
                            Master.whatActionIfClickMouse = "move";
            ...
            spend100$.addListener(new ClickListener(){
                @Override
                public void clicked(InputEvent event, float x, float y) {
            ...
            spend200$.addListener(new ClickListener(){
                @Override
                public void clicked(InputEvent event, float x, float y) {
                    super.clicked(event, x, y);
                    if(!spent) {
            ...
            spend500$.addListener(new ClickListener(){
                @Override
                public void clicked(InputEvent event, float x, float y) {
                    super.clicked(event, x, y);
                    if(!spent) {
            ...
            spend1Day.addListener(new ClickListener(){
                @Override
                public void clicked(InputEvent event, float x, float y) {
                    super.clicked(event, x, y);
                    if(!spent) {
                        soNgayGui = 1;
                        spend1Day.setColor(1,1,1,1);
                        spend2Day.setColor(1,1,1,1);
                        spend5Day.setColor(1,1,1,1);
                        spend100$.setColor(1,1,1,1);
                        spend200$.setColor(1,1,1,1);
                        spend500$.setColor(1,1,1,1);
                    }
                }
            });
            spend2Day.addListener(new ClickListener(){
                @Override
                public void clicked(InputEvent event, float x, float y) {
                    super.clicked(event, x, y);
                    if(!spent) {
            ...
            spend5Day.addListener(new ClickListener(){
                @Override
                public void clicked(InputEvent event, float x, float y) {
                    super.clicked(event, x, y);
                    if(!spent) {
            ...
            claimMoney.addListener(new ClickListener(){
                ...
                public void clicked(InputEvent event, float x, float y) {
                    super.clicked(event, x, y);
                    spent = false;
                    GameState.money += soTienGui + soTienGui*0.1*soNgayGui;
                    timeBank = 0;
                    soTienGui = 0;
                    soNgayGui = 0;
                    canClaim = false;
        ...
        bank = new Bank(32*13, 32 *7,stage);
        ...
        broom.remove();
        buyAx = new Ax(32*5,Gdx.graphics.getHeight()-32*11,noMoveStage);
        buyAx.remove();
        ax = new Ax(0,0,noMoveStage);
        ax.setTouchable(Touchable.disabled);
        ax.remove();
        ...
        bangRent = new Bang(-10000 ,1000,noMoveStage);
        ...
        bankCross = new Cross(-100000,-10000,noMoveStage );
        rentCross = new Cross(-10000 , 10000, noMoveStage);
        ...
        bangBank = new Bang(-10000 ,100 , noMoveStage);
        pho = new Pho(10000,10000,noMoveStage,this);
        ...
        rentHouse = new RentHouse(32*32-16 , 0 , stage);
                ...
                public boolean mouseMoved(InputEvent event, float x, float y) {
                    try{
                        ...
                        if(thongTinMode) {
                            ...
                            if(actor instanceof CamRiu){
                                thongTinNutRiu = true;
                            }else {
                                thongTinNutRiu = false;
                            }
        ...
        stage.addListener(new InputListener(){
            ...
            public boolean mouseMoved(InputEvent event, float x, float y) {
                try{
                    ...
                    MyActor actorBlockChat = (MyActor) stage.hit(x2+32, y2+32*2, true);
                    if(actorBlockChat instanceof Tree){
                        isCanChat=true;
                    }else{
                        isCanChat=false;
                    }
    ...
    public void show() {
        ...
        rentHouse.addListener(new ClickListener() {
            public void clicked(InputEvent event, float x, float y) {
                openRentHouse();
                whatActionIfClickMouse = "thueNguoiTrongCay";
            }
        });
        rentCross.addListener(new ClickListener(){
            @Override
            public void clicked(InputEvent event, float x, float y) {
                closeRentHouse();
            }
        ...
        bankCross.addListener(new ClickListener(){
            @Override
            public void clicked(InputEvent event, float x, float y) {
                super.clicked(event, x, y);
                closeBank();
        ...
        buyAx.addListener(new ClickListener() {
            public void clicked(InputEvent event, float x, float y) {
                if(!GameState.isCoRiu){
                    if(GameState.money>=300) {
                        GameState.isCoRiu = true;
                        noMoveStage.addActor(ax);
                        ax.toFront();
                        GameState.money-=300;
        ...
        nangCapMLKK.addListener(new ClickListener() {
            public void clicked(InputEvent event, float x, float y) {
                if(GameState.money >= 1000*sotiencangiam/100 && GameState.ernegy >= 5){
                    try{
        ...
        nangCapGTX.addListener(new ClickListener() {
            public void clicked(InputEvent event, float x, float y) {
                if(isGTX && GameState.money >= 1000*sotiencangiam/100 && GameState.ernegy >= 50 && GameState.greenscore >= 20){
        ...
        nangCapCNX.addListener(new ClickListener() {
            public void clicked(InputEvent event, float x, float y) {
                if(isCNX && GameState.money >= 1500*sotiencangiam/100 && GameState.ernegy >= 30 && GameState.greenscore >= 30){
    ...
    public void render(float v) {
        ...
        if(isInTurtleMap){
            ...
            image2.setPosition(32*20,Gdx.graphics.getHeight()-32*6-88);
            image3 .setPosition(32*20, Gdx.graphics.getHeight() - 32*7-110);
            ...
            image.toFront();
            image2.toFront();
            image4.setPosition(32*22 , Gdx.graphics.getHeight()-32*4-50-10);
            image5.setPosition(32*22 , Gdx.graphics.getHeight()-32*5-75);
            image4.toFront();
            image5 .toFront();
        }else {
        ...
        if(canClaim && inBank){
            claimMoney.setPosition( 32*12, Gdx.graphics.getHeight() - 32*15);
            claimMoney.toFront();
        }else {
...
//        }
    ...
    private void vietChuDuoi(){
        if(this.dark.getColor().a == 0) {
            ...
            game.font.draw(batch, GameState.day+"/"+GameState.month +"/"+GameState.year, Gdx.graphics.getWidth() - 120, 25);
            vietTypeVLLD();
    ...
    private void vietChuTren(){
        ...
        if(thongTinMode){
            ...
            if(thongTinNutRiu){
                game.fontTextField.draw(batch, "Tắt/bật chế độ cầm rìu", 700-50*4-20, Gdx.graphics.getHeight() - 120-45*2);
            }
            if(thongTinNutXeCo){
            ...
            if(thongTinRiu){
                game.font3.draw(batch, "Dùng để chặt cây",  ax.getX(),ax.getY());
            }
            if(thongTinXeRac){
                game.font3.draw(batch, "Khi lái xe này có thể dọn rác",  trashTruck.getX(),trashTruck.getY());
            }
            if(thongTinTaxi){
                game.font3.draw(batch, "Xe taxi vừa rẻ vừa nhanh",  taxi.getX(),taxi.getY());
            }
            if(thongTinPolice){
        ...
        if(inRentHouse){
            game.font3.draw(batch, "Thuê 1 người trồng cây giá 1000$",thueNguoiTrongCay.getX()+32,Gdx.graphics.getHeight()-32*5-8+25+(64-25)/2f);
        }
        if(hienNghienCuu){
            try {
                ...
                game.font5.draw(batch, 1000*sotiencangiam/100+" money, 5 energy", 32 * 20, Gdx.graphics.getHeight() - 32 * 5.5f - (25 + 8 * 2) - 16 - 32);
            }catch(Exception e) {
            ...
            if(isCNX) {
                game.font5.draw(batch, 1500*sotiencangiam/100+" money, 30 ernegy",32*16, Gdx.graphics.getHeight()-32*9-(25+8*2)-16*5-10);
            ...
            if(isGTX) {
                game.font5.draw(batch, 1000*sotiencangiam/100+" money, 50 ernegy",32*2, Gdx.graphics.getHeight()-32*9-(25+8*2)-16*5-10);
                game.font5.draw(batch, "20 greenscore",32*2, Gdx.graphics.getHeight()-32*9-(25+8*2)-16*5-25-10);
            }
        }
        if(hienCheTao){
            game.font5.draw(batch, 500*sotiencangiam/100+" money, 5 energy",32*20+10,Gdx.graphics.getHeight() * 0.6f+50-12.5f-10);
            ...
            game.font5.draw(batch, 1000*sotiencangiam/100+" money, 50 energy",32*20+10, Gdx.graphics.getHeight() * 0.6f-50*4);
        ...
        if(hienCongCu){
            ...
            game.font3.draw(batch, ": Chổi giá 300$",buyBroom.getX()+buyBroom.getWidth()/2f+32*2
                ,Gdx.graphics.getHeight()-32*8+25);
            game.font3.draw(batch, ": Rìu giá 300$",buyAx.getX()+buyAx.getWidth()/2f+32*2
                ,Gdx.graphics.getHeight()-32*11+25);
        }
        if(hienXayDung){
        ...
        if(isInTurtleMap){
            ...
            game.font3.draw(batch , "Được tặng một cái camera", 32*10,Gdx.graphics.getHeight() -32*3-15);
            game.font3.draw(batch , "Được tặng hai mươi điểm xanh", 32*10,Gdx.graphics.getHeight() -32*4-30);
            game.font3.draw(batch , "Được tặng năm mươi năng lượng", 32*10,Gdx.graphics.getHeight() -32*5-45);
            game.font3.draw(batch , "Được tặng hai cái biển cấm", 32*10,Gdx.graphics.getHeight() -32*6-60);
            game.font3.draw(batch , "Được tặng ba hạt giống cây", 32*10,Gdx.graphics.getHeight() -32*7-75);
            game.font3.draw(batch , "Nhận 1 thẻ chiến binh ngẫu nhiên ", 32*10,Gdx.graphics.getHeight() -32*8-90);
        }
        if(inBank){
            ...
            game.font3.draw(batch, "Gửi 2 ngày",spend1Day.getX()+ 32*2-6,Gdx.graphics.getHeight() -32*8);
            game.font3.draw(batch, "Gửi 5 ngày",spend1Day.getX()+ 32*2-6,Gdx.graphics.getHeight() -32*12);
            game.font3.draw(batch, "Bạn gửi ngân hàng " + soTienGui,32*12,Gdx.graphics.getHeight() -32*4);
            game.font3.draw(batch, "Bạn đã gửi " + soNgayGui + " ngày",32*13-16,Gdx.graphics.getHeight() -32*7);
            game.font3.draw(batch, "Số tiền lãi là : " + soTienGui*0.1*soNgayGui,32*13-16,Gdx.graphics.getHeight() -32*10);
            if(canClaim) {
                game.font3.draw(batch, "Nhận", claimMoney.getX() + 32 * 2 + 19, Gdx.graphics.getHeight() - 32 * 14 + 6);
            }
    ...
    private void batTatNutMoVaXuLyTrongNutMo(){
        ...
        if(isMoItems){
            ...
            noMoveStage.addActor(riuButton);
        }else {
            xengButton.remove();
            choiButton.remove();
            riuButton.remove();
        ...
        if(whatActionIfClickMouse.equals("CamXeng")){
            ...
            MDirt.setPosition(x, y-2);
            MDirt.toFront();
        }else if(whatActionIfClickMouse.equals("CamRiu")){
            if(ax.getStage() == null){
                noMoveStage.addActor(ax);
                ax.toFront();
            }
            ax.setPosition(mouseNoMoveStage.x,mouseNoMoveStage.y);
            float x = Math.round(mouseNoMoveStage.x/32f)*32+(32-stage.getCamera().position.x%32) - 32+32;
            float y = Math.round(mouseNoMoveStage.y/32f)*32+(32-stage.getCamera().position.y%32) - 48+32*2;
            deltaXYVector.set((float) Gdx.graphics.getWidth() /2 - x, (float) Gdx.graphics.getHeight() /2 - y+2);
            MDirt.setPosition(x, y-2);
            MDirt.toFront();
        }else {
    ...
    private void xulyngaythangnam(){
        // o day ko xu ly tang ngay nua vi cho ngay dem co roi
        if(GameState.day==31){
            GameState.month++;
            GameState.day=1;
        }
        if(GameState.month==13){
            GameState.year++;
            GameState.month=1;
        }
        if(timeOfDay%60==0){
            if(
                (GameState.day==1 && GameState.month ==1)
                    || (GameState.day==2 && GameState.month ==2)
                    || (GameState.day==3 && GameState.month ==3)
                    || (GameState.day==13 && GameState.month ==3)
                    || (GameState.day==5 && GameState.month ==4)
                    || (GameState.day==11 && GameState.month ==5)
                    || (GameState.day==17 && GameState.month ==6)
                    || (GameState.day==25 && GameState.month ==7)
                    || (GameState.day==30 && GameState.month ==8)
                    || (GameState.day==21 && GameState.month ==9)
                    || (GameState.day==15 && GameState.month ==10)
                    || (GameState.day==10 && GameState.month ==11)
                    || (GameState.day==13 && GameState.month ==12)
            ...
            if(
                (GameState.day==1 && GameState.month ==1)
                    || (GameState.day==22 && GameState.month ==2)
                    || (GameState.day==4 && GameState.month ==3)
                    || (GameState.day==10 && GameState.month ==3)
                    || (GameState.day==5 && GameState.month ==4)
                    || (GameState.day==17 && GameState.month ==5)
                    || (GameState.day==3 && GameState.month ==6)
                    || (GameState.day==4 && GameState.month ==7)
                    || (GameState.day==5 && GameState.month ==8)
                    || (GameState.day==2 && GameState.month ==9)
                    || (GameState.day==1 && GameState.month ==10)
                    || (GameState.day==15 && GameState.month ==11)
                    || (GameState.day==6 && GameState.month ==12)
                    || (GameState.day==20 && GameState.month ==12)
            ){
                if(!isNgayGiamGia){
                ...
                if(sotiencangiam!=100){
                    sotiencangiam=100;
                }
            }
            if(
                (GameState.day==5 && GameState.month ==1)
                    || (GameState.day==8 && GameState.month ==2)
                    || (GameState.day==11 && GameState.month ==3)
                    || (GameState.day==5 && GameState.month ==3)
                    || (GameState.day==1 && GameState.month ==4)
                    || (GameState.day==6 && GameState.month ==5)
                    || (GameState.day==3 && GameState.month ==6)
                    || (GameState.day==17 && GameState.month ==7)
                    || (GameState.day==27 && GameState.month ==8)
                    || (GameState.day==8 && GameState.month ==9)
                    || (GameState.day==19 && GameState.month ==10)
                    || (GameState.day==25 && GameState.month ==11)
                    || (GameState.day==30 && GameState.month ==12)
                    || (GameState.day==24 && GameState.month ==12)
            ){
                if(!isNgayQuyenGop){
...
//        }
    ...
    public void openBank(){
        ...
        spend1Day.setPosition(Gdx.graphics.getWidth() - 32*10 , Gdx.graphics.getHeight() - 32*5-6);
        spend2Day.setPosition(Gdx.graphics.getWidth() - 32*10, Gdx.graphics.getHeight() - 32*9-6);
        spend5Day.setPosition(Gdx.graphics.getWidth() - 32*10, Gdx.graphics.getHeight() - 32*13-6);
    ...
    public void closeBank(){
        bangBank.setPosition(100000,1000);
        bankCross.setPosition(10000,100000);
        whatActionIfClickMouse = "move";
        inBank = false;
        spend100$.setPosition(100000,10000);
        spend200$.setPosition(100000,10000);
        spend500$.setPosition(100000,10000);
